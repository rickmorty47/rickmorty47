...
export class changeStateEnum1597704274136 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."states_state_enum" AS ENUM('Empty', 'AskGetPointMenuRequest', 'AskSetPointMenuRequest', 'SetPointMessageRequest', 'SetHelpMessageRequest')`);
